...
export const SIMULATED_PARCOURS: QuizItem[] = [
  { id: 1001, course: null, formation: 1, title: "QCM - Connaissance de Soi",                pass_threshold: 12, active: true, questions: [], created_at: "2026-02-10T12:00:00Z", generated_by_ai: true,  ai_source: "SCRIPT", niveau: "FACILE",        rang: 1, branche: "GENERALE", status: "PUBLISHED" },
  { id: 1002, course: null, formation: 1, title: "QCM - Gestion des Émotions",                pass_threshold: 12, active: true, questions: [], created_at: "2026-02-18T12:00:00Z", generated_by_ai: true,  ai_source: "SCRIPT", niveau: "INTERMEDIAIRE", rang: 2, branche: "GENERALE", status: "PUBLISHED" },
  { id: 1,    course: null, formation: 1, title: "Examen final - Développement Personnel",    pass_threshold: 14, active: true, questions: [], created_at: "2026-02-10T12:00:00Z", generated_by_ai: false, ai_source: null,     niveau: "DIFFICILE",     rang: 3, branche: "GENERALE", status: "PUBLISHED" },
  { id: 1003, course: null, formation: 3, title: "QCM - Introduction à l'Ashé",               pass_threshold: 10, active: true, questions: [], created_at: "2026-03-12T09:00:00Z", generated_by_ai: true,  ai_source: "PDF",    niveau: "FACILE",        rang: 4, branche: "GENERALE", status: "DRAFT" },
