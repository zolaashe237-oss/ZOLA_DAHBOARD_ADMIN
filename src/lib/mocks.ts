...
export const MOCK_PLANS: SubscriptionPlan[] = [
  {
    ...
    nb_tranches: 1,
    tranche_amount: null,
    description: "Accès annuel à l'Espace Membres. Un seul règlement de 45 700 FCFA pour toute l'année.",
    is_active: true,
  ...
  },
  {
    ...
    nb_tranches: 1,
    tranche_amount: null,
    description: "Cotisation mensuelle ouverte à tous. Renouvellement automatique chaque mois.",
    is_active: true,
    access_levels: ["MEMBRE", "FEMME", "ENFANT"],
    formation_ids: [],
    created_at: "2026-01-01T00:00:00Z",
    updated_at: "2026-01-01T00:00:00Z",
  },
